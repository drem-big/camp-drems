    ...
    campsiteList.forEach(campsite => {
        ...
        userFavoriteCampsiteRef.once('value')
            .then(snapshot => {
                ...
                let city = null;
                if(campsite.FACILITYADDRESS && campsite.FACILITYADDRESS[0] && campsite.FACILITYADDRESS[0].City) {
                ...
                let recArea = null;
                if(campsite.RECAREA && campsite.RECAREA[0] && campsite.RECAREA[0].RecAreaName) {
